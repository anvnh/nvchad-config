...
M.general = {
  ...
  n = {
    ...
    ["<C-Up>"] = { "<cmd> resize +2 <CR>", "Increase window size" },
    ["<C-Down>"] = { "<cmd> resize -2 <CR>", "Decrease window size" },
    ["<C-Right>"] = { "<cmd> vertical resize +5 <CR>", "Increase window size" },
    ["<C-Left>"] = { "<cmd> vertical resize -5 <CR>", "Decrease window size" },
